# This API endpoint has been permanently removed. 2022-10-11
...
# #'
# #' @export
# cr_get_current_war <- function(clan = '99R2PQVR', key = cr_get_key()) {
#
#   # Check inputs ---------------------------------------------------------------
...
#
#   # Use inputs -----------------------------------------------------------------
#   url <- paste0(get_api_url(), 'clans/%23', clan, '/currentwar')
#
#   # Call to API ----------------------------------------------------------------
